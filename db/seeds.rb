...
offers = [
  ...
  },
  {
    ...
    description: "Race with the 1997 Porsche 993 Cup 3.8 RSR, a high-performance machine built for those who crave speed and precision. This track-focused Porsche is equipped with a powerful 3.8L engine and advanced racing technology, making it a formidable contender on the circuit. Perfect for track days or simply enjoying an adrenaline-fueled drive, the 993 Cup RSR is a testament to Porsche's engineering excellence and racing heritage."
  },
  {
    brand: 'Porsche',
